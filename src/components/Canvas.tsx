...
const Canvas = ({canvasItems, setCanvasItems} : Props) => {
  ...
  return (
    <div
      ref={drop}
      className={cx(
        "h-[calc(100vh-6rem)] w-[calc(100vw-12rem)] p-10 overflow-x-auto overflow-y-auto scrollbar-hide absolute top-24 left-48 bg-[#242020] flex flex-row flex-wrap justify-evenly content-start",
